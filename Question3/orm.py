...
class ORM:
    ...
    # def query(self,where_clause="",values=tuple()):
    #     SQL = "SELECT * FROM employees JOIN employees_branches ON employees.pk = employees_branches.employees_pk JOIN branches ON branches.pk = employees_branches.branches_pk {};"
